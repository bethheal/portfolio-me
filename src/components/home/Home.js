            ...
            <Box>
                ...
                <Box component={'ul'} p={'0.8rem'}>
                 ...
                 <Box mt={'2rem'} mb={'2rem'} textAlign={'center'}>
                    <a href="https://emerald-kimmy-83.tiiny.site" download="resume.pdf">
                        <Box component="button" p={'0.5rem 1rem'} borderRadius={'8px'} backgroundColor={info.baseColor} color={'white'} border={'none'} cursor={'pointer'}>
                            Download Resume
                        </Box>
                    </a>
                </Box>
